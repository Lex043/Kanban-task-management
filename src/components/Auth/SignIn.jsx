        ...
        <section className="text-white lg:grid lg:grid-cols-[40%_60%] h-full">
            <div className="px-4 pt-32 pb-20 md:px-20 md:pt-28 lg:pt-10">
                <section className="flex flex-col gap-8">
                    <header>
                        <h1 className="pb-1 text-2xl font-bold">Log in</h1>
                        <p className="text-sm">
                ...
                >
                    ...
                    <label className="flex flex-col">
                        <div className="flex justify-between mb-2 text-sm">
                            ...
                            <span className="text-[#a8a4ff] cursor-pointer">
                                Forgot password?
                            </span>
                        </div>
                        <input
            ...
            <section className="hidden lg:flex flex-col bg-[#20212c] h-full pt-10 min-h-screen overflow-hidden">
                <div className="pl-20">
